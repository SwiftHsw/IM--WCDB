...
//        (AppDelegate *)[[UIApplication sharedApplication] delegate].mainTabBar.tabBar.alpha = 0;
        [UIView getCurrentVC].tabBarController.tabBar.alpha = 0;
...
//    kAppDelegate.mainTabBar.tabBar.alpha = 0;
    ...
    [UIView animateWithDuration:self.animationDuration animations:^{
        ...
        [UIView getCurrentVC].tabBarController.tabBar.alpha = 1;
    } completion:^(BOOL finished) {
        //        if (finished) {
